...
function makeTwo() {
	...
	paragraph2.textContent = firstForm.getAttribute('name');
}
...
function makeThree() {
	...
	paragraph3.textContent = lastForm.getAttribute('name');
}
...
function makeFour() {
	...
	paragraph4.textContent = formNames;
}
...
function makeSeven() {
	...
	for(element of formElements){
		elementsList+= `<br /> - ${element.getAttribute('name')};`;
	}
	paragraphSeven.innerHTML = `Название всех элементов второй формы: ${elementsList}`;
}
...
function makeEight() {
	...
	paragraphEight.innerHTML = `Название всех элементов первой формы: ${elementsList}`;
}
...
function makeNine() {
	...
	paragraphNine.innerHTML = `Название всех элементов третьей формы: ${elementsList}`;
}
...
function makeTen() {
	const radioFour = document.forms[3].elements.fourthName.value;
	paragraphTen.textContent = radioFour;
}
...
function makeEleven() {
	const select = document.forms[0].elements.firstSelect;
	let optionsValues = '';
	for(option of select){
		optionsValues+= `<br /> - ${option.value};`;
	}
	paragraphEleven.innerHTML = `Значения опций первой формы: ${optionsValues}`;
}
...
function makeTwelve() {
    ...
    const checkboxOne = elements.checkboxOne;
	const checkboxTwo = elements.checkboxTwo;
	const checkboxThree = elements.checkboxThree;
	paragraphTwelve.innerHTML = `Значение атрибутов id чекбоксов второй формы: <br /> - ${checkboxOne.getAttribute('id')}; <br /> - ${checkboxTwo.getAttribute('id')}; <br /> - ${checkboxOne.getAttribute('id')}; `;
}
...
function checkButton() {
	const radioButton = document.forms[3].elements.fourthName;
...
function checkOption() {
	const firstSelect = document.forms[0].elements.firstSelect;
	firstSelect.selectedIndex = 1;
	if(firstSelect[0].selected){
		paragraphFourteen.textContent = 'Выбран первый вариант'
	}
	if(firstSelect[1].selected){
		paragraphFourteen.textContent = 'Выбран второй вариант'
	}
	if(firstSelect[2].selected){
...
function makeSixteen() {
	const checkboxThree = document.forms[1].elements.checkboxThree;
...
formOne.addEventListener('submit', function (event) {
	...
	if(firstName.value == '' || firstEmail.value == '' || firstSelect.selected){
...
const selectElement = document.forms[0].elements.firstSelect;
...
emailInput.oninput = function () {
	...
	const emailBorder = document.getElementById('firstEmail');
...
const checkboxFour = document.forms[3].elements.fourthName;
const buttonFour = document.forms[3].elements.fourthButton;

checkboxFour.onchange = function(){
...
document.querySelector('.b-26').onclick = function (event) {
	...
	const thirdName = document.forms[2].elements.thirdName;
	result.textContent = thirdName.getAttribute('placeholder');
};
